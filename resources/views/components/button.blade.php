...
@php
    $buttonClasses = generateClasses([
        ...
        'text-zinc-800 bg-white border hover:bg-gray-50 focus:ring-primary-600 focus:text-primary-600 focus:bg-primary-50 focus:border-primary-600' => $color === 'secondary',
