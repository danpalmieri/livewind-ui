...
@php
    $buttonClasses = generateClasses([
        ...
        'text-black bg-white border border-black/20 hover:bg-zinc-50 focus:ring-primary-600 focus:text-primary-600 focus:bg-primary-50 focus:border-primary-600' => $color === 'secondary',
