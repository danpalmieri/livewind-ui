...
<{{ $tag }}
    ...
    @if($eventLoadingFeedback) onclick="console.log({{ $id }}); new CustomEvent('button-loading-event', {{ json_encode(['detail' => ['id' => $id, 'event' => $eventLoadingFeedback, 'icon' => $icon]]) }})" @endif
