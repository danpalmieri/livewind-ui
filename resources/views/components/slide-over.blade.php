        ...
        >
            <div class="flex items-center justify-between flex-shrink-0 px-4 border-b h-14">
                ...
                <button
                    x-on:click="open = false"
                    type="button"
                    class="flex items-center justify-center w-10 h-10 -mr-2 text-zinc-500 transition rounded-full focus:text-primary-600 hover:bg-gray-500/5 focus:bg-primary-500/10 focus:outline-none"
                >
